...
export const GAME_ACTIONS = {
  ...
  ANIMATE_PIECE_MOVE: 'ANIMATE_PIECE_MOVE',
  START_PIECE_ANIMATION: 'START_PIECE_ANIMATION',
  STEP_PIECE_ANIMATION: 'STEP_PIECE_ANIMATION',
  END_PIECE_ANIMATION: 'END_PIECE_ANIMATION',
